...
public abstract class MapStateListener {
    ...
    public MapStateListener(GoogleMap map, CustomMapsFragment touchableMapFragment, Activity activity) {
        this.mMap = map;
        ...
        touchableMapFragment.setTouchListener(new CustomMapsFragment.TouchableWrapper.OnTouchListener() {
            @Override
            public void onTouch() {
                touchMap();
                unsettleMap();
